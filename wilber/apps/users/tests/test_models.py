...
class TestCaseUser(TestCase):
    ...
    def test_attribute_count(self):
        """
        Test that all attributes of User server are counted. It will count the primary key and all editable attributes.
    ...
    def test_attribute_content(self):
        """
        Test that all attributes of User server have content. This test will break if an attributes name is changed.
        """
        user = UserFactory.create()
    ...
    def test_username_is_unique(self):
        ...
        try:
            ...
            self.assertEqual(str(e), 'UNIQUE constraint failed: users_user.username')
...
class TestCaseUserProfile(TestCase):
    ...
    def test_attribute_count(self):
        """
        Test that all attributes of UserProfile server are counted. It will count the primary key and all editable attributes.
        This test should break if a new attribute is added.
        """
    ...
    def test_attribute_content(self):
        """
        Test that all attributes of UserProfile server have content. This test will break if an attributes name is changed.
        """
    ...
    def test_user_is_unique(self):
        ...
        try:
            ...
            self.assertEqual(str(e), 'UNIQUE constraint failed: users_userprofile.user_id')
