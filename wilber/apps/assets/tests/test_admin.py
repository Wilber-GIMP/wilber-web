...
class AssetAdminTest(TestCase):
    ...
    def setUp(self):
        ...
        self.asset = Asset.objects.create(name='Test Asset Admin 10', owner=self.user, category=TEST_CATEGORY)
        self.asset2 = Asset.objects.create(name='Test Asset Admin 20', owner=self.user, category=TEST_CATEGORY)
