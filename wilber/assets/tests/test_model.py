...
class AssetTests(TestCase):
    ...
    def setUp(self):
        ...
        self.asset = Asset.objects.create(name='Test Asset Model 1', owner=self.user)
        self.asset2 = Asset.objects.create(name='Test Asset Model 2', owner=self.user)

    def test_simple_asset(self):
        asset = Asset.objects.get(id=1)
        expected_object_name = str(asset)
        self.assertEquals(expected_object_name, 'Test Asset Model 1')
    ...
    def test_asset_with_existing_file(self):
        ...
        asset.image.save('image-name', File(open('test/image.jpg', 'rb')))
    ...
    def test_like(self):
        ...
        self.assertEqual(str(like), 'john likes Test Asset Model 1')
    ...
    def test_asset_list_view(self):
        ...
        self.assertContains(response, 'Test Asset Model 1')
